...
import static parser.Lesson.EVERY_WEEK;
import static parser.Lesson.LOWER_WEEK;
import static parser.Lesson.UPPER_WEEK;
...
public class Lesson extends Model {
    ...
    private Calendar getFirstLessonDate(WeekDays wd) {
        ...
        if (week == LOWER_WEEK) {
            ...
            if (lower.before(upper)) date = lower;
            else date = upper;
        }
    ...
    private Calendar getLastLessonDate(WeekDays wd) {
        ...
        if (week == LOWER_WEEK) {
            ...
            if (lower.after(upper)) date = lower;
            else date = upper;
        }
